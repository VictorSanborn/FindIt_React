...
class ResultField extends Component {
    ...
    componentDidUpdate = (prevProps, prevState) => {
        if (this.props.dataField === "Dryck"){
            if (this.props.businessForProduct !== prevProps.businessForProduct){
        ...
        <a className="row ListItemClickable" href={this.props.dataField === "Verksamhet"? '/Business/' + this.props.itemId : undefined}>
            <div class="col-sm-12">
                ...
                {this.props.dataField == "Dryck" ?
                    this.props.price != null && this.props.businessForProduct && this.props.businessForProduct.id ?
